...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_pubsub_5fmsg_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::pubsub_msg_t, selfip_),
  PROTOBUF_FIELD_OFFSET(::pubsub_msg_t, id_),
};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_pubsub_5fmsg_2eproto = {
  &descriptor_table_pubsub_5fmsg_2eproto_initialized, descriptor_table_protodef_pubsub_5fmsg_2eproto, "pubsub_msg.proto", 133,
...
pubsub_msg_t::pubsub_msg_t(const pubsub_msg_t& from)
  ...
  if (!from._internal_selfip().empty()) {
    selfip_.AssignWithDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from.selfip_);
  }
    ...
    switch (tag >> 3) {
      ...
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 42)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8(_internal_mutable_selfip(), ptr, ctx, "pubsub_msg_t.selfIp");
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      // string id = 6;
      case 6:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 50)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8(_internal_mutable_id(), ptr, ctx, "pubsub_msg_t.id");
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
...
::PROTOBUF_NAMESPACE_ID::uint8* pubsub_msg_t::InternalSerializeWithCachedSizesToArray(
  ...
  if (this->selfip().size() > 0) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      this->_internal_selfip().data(), static_cast<int>(this->_internal_selfip().length()),
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "pubsub_msg_t.selfIp");
    target = stream->WriteStringMaybeAliased(
        5, this->_internal_selfip(), target);
  }
...
void pubsub_msg_t::InternalSwap(pubsub_msg_t* other) {
  ...
  remoteip_.Swap(&other->remoteip_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
    GetArenaNoVirtual());
  selfip_.Swap(&other->selfip_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
    GetArenaNoVirtual());
