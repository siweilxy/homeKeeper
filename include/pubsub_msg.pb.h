...
class pubsub_msg_t :
 ...
 public:
  ...
  void _internal_set_selfip(const std::string& value);
...
// string selfIp = 5;
inline void pubsub_msg_t::clear_selfip() {
  selfip_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline const std::string& pubsub_msg_t::selfip() const {
  // @@protoc_insertion_point(field_get:pubsub_msg_t.selfIp)
  return _internal_selfip();
}
inline void pubsub_msg_t::set_selfip(const std::string& value) {
  _internal_set_selfip(value);
  // @@protoc_insertion_point(field_set:pubsub_msg_t.selfIp)
}
inline std::string* pubsub_msg_t::mutable_selfip() {
  // @@protoc_insertion_point(field_mutable:pubsub_msg_t.selfIp)
  return _internal_mutable_selfip();
}
inline const std::string& pubsub_msg_t::_internal_selfip() const {
  return selfip_.GetNoArena();
}
inline void pubsub_msg_t::_internal_set_selfip(const std::string& value) {
  
  selfip_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
}
inline void pubsub_msg_t::set_selfip(std::string&& value) {
  
  selfip_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:pubsub_msg_t.selfIp)
}
inline void pubsub_msg_t::set_selfip(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  selfip_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:pubsub_msg_t.selfIp)
}
inline void pubsub_msg_t::set_selfip(const char* value, size_t size) {
  
  selfip_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:pubsub_msg_t.selfIp)
}
inline std::string* pubsub_msg_t::_internal_mutable_selfip() {
  
  return selfip_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* pubsub_msg_t::release_selfip() {
  // @@protoc_insertion_point(field_release:pubsub_msg_t.selfIp)
  
  return selfip_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void pubsub_msg_t::set_allocated_selfip(std::string* selfip) {
  if (selfip != nullptr) {
    
  } else {
    
  }
  selfip_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), selfip);
  // @@protoc_insertion_point(field_set_allocated:pubsub_msg_t.selfIp)
}

// string id = 6;
inline void pubsub_msg_t::clear_id() {
  id_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline const std::string& pubsub_msg_t::id() const {
  // @@protoc_insertion_point(field_get:pubsub_msg_t.id)
  return _internal_id();
}
inline void pubsub_msg_t::set_id(const std::string& value) {
  _internal_set_id(value);
  // @@protoc_insertion_point(field_set:pubsub_msg_t.id)
}
inline std::string* pubsub_msg_t::mutable_id() {
  // @@protoc_insertion_point(field_mutable:pubsub_msg_t.id)
  return _internal_mutable_id();
}
inline const std::string& pubsub_msg_t::_internal_id() const {
  return id_.GetNoArena();
}
inline void pubsub_msg_t::_internal_set_id(const std::string& value) {
  
  id_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
}
inline void pubsub_msg_t::set_id(std::string&& value) {
  
  id_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:pubsub_msg_t.id)
}
inline void pubsub_msg_t::set_id(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  id_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:pubsub_msg_t.id)
}
inline void pubsub_msg_t::set_id(const char* value, size_t size) {
  
  id_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:pubsub_msg_t.id)
}
inline std::string* pubsub_msg_t::_internal_mutable_id() {
  
  return id_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* pubsub_msg_t::release_id() {
  // @@protoc_insertion_point(field_release:pubsub_msg_t.id)
  
  return id_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void pubsub_msg_t::set_allocated_id(std::string* id) {
  if (id != nullptr) {
  ...
  // @@protoc_insertion_point(field_set_allocated:pubsub_msg_t.id)
}
